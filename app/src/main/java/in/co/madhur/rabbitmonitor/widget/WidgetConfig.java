...
public class WidgetConfig {
    ...
    public void RefreshData(AppPreferences appPreferences)
    {
        ...
        setTitleColor(appPreferences.GetColor(AppPreferences.Keys.WIDGET_TITLE_COLOR));
        setCountColor(appPreferences.GetColor(AppPreferences.Keys.WIDGET_COUNT_COLOR));
